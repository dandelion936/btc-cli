  ...
  <div class="d2-multiple-page-control-group" flex>
    ...
    <div
      ...
      <el-dropdown
        ...
        <d2-icon name="base-times-circle"/>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="left">
            <d2-icon name="base-arrow-left" class="d2-mr-10"/>
            {{ $t('layout.header-aside.tabs.close-left') }}
          </el-dropdown-item>
          <el-dropdown-item command="right">
            <d2-icon name="base-arrow-right" class="d2-mr-10"/>
            {{ $t('layout.header-aside.tabs.close-right') }}
          </el-dropdown-item>
          <el-dropdown-item command="other">
            <d2-icon name="base-times" class="d2-mr-10"/>
            {{ $t('layout.header-aside.tabs.close-other') }}
          </el-dropdown-item>
          <el-dropdown-item command="all">
            <d2-icon name="base-times-circle" class="d2-mr-10"/>
...
export default {
  ...
  computed: {
    ...
    contextmenuList () {
      return [
        { icon: 'base-arrow-left', title: this.$t('layout.header-aside.tabs.close-left'), value: 'left' },
        { icon: 'base-arrow-right', title: this.$t('layout.header-aside.tabs.close-right'), value: 'right' },
        { icon: 'base-times', title: this.$t('layout.header-aside.tabs.close-other'), value: 'other' },
        { icon: 'base-times-circle', title: this.$t('layout.header-aside.tabs.close-all'), value: 'all' }
      ]
    }
  },
  methods: {
