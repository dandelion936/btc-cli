<template>
    ...
    >
        ...
        <div
            :style="{height: selectedColorHeight + 'px'}"
            class="color-show"
        >
            <div class="show">
...
export default {
    ...
    updated() {
      this.$emit('setPosition',{
        width: this.$refs.colorPicker.clientWidth,
        height: this.$refs.colorPicker.clientHeight + 6
      })
    },
    destroyed() {
