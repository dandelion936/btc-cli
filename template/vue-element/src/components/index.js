...
Vue.component('vue-viewer', () => import('./vue-viewer'))
Vue.component('d2-upload', () => import('./d2-upload'))
Vue.component('d2-outport', () => import('./d2-outport'))
Vue.component('d2-import', () => import('./d2-import'))
Vue.component('d2-color', () => import('./d2-color'))
